<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <script type='text/javascript'>
	    ...
	    function goPage(pg) {
	        $(location).attr('href', '${pageContext.request.contextPath}/property/searchPro/'+pg);
	    }
	    
	    function getCategoryIndex( idx, propuservalue ){
			var str = "";
			$.ajax(
				{
					type:"POST",
					url: '${pageContext.request.contextPath}/property/addtoFavorite/'+propuservalue,
					dataType:"text",
					success:function(datum){
						if (datum == 1){
							alert("관심목록에 저장되었습니다");
						} else{
							alert("관심목록에 저장되는데 실패하였습니다")
						}
					},
					error:function(e){
						alert("bad");
                                            ...
                                            <div class="property-grid ">                                                        
                                                <div class="to-thumb col-sm-4 p0">
                                                    <img src="${pageContext.request.contextPath}/img/demo/property1.jpg" alt="">      
                                                     <span class="spn-save"><a onclick="getCategoryIndex(${loop.index},'${sb:getIdStr(printlist.propId)}/${sb:getIdStr(sbmemberdo.userId)}')" href="#"><i class="ti ti-heart"></i></a></span>
                                                      <div class="user-preview">
                                                        ...
                                                        <a class="proeprty-sh-more-list" href="${pageContext.request.contextPath}/property/detail/${sb:getIdStr(sbmemberdo.userId)}/${sb:getIdStr(printlist.propId)}"><i class="ti ti-share"> </i></a>

                                                </div>
                                                
                                                <div class="to-details col-sm-8 p0">
                                                    <div class="property-top-cnt">
                                                        <h3><a href="${pageContext.request.contextPath}/property/detail/${sb:getIdStr(sbmemberdo.userId)}/${sb:getIdStr(printlist.propId)}" title="">${printlist.aptName}</a></h3>
