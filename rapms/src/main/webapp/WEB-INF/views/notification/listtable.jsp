<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
	...
	<script type="text/javascript">
	    ...
	    function goPage(pg) {
	        $(location).attr('href', '${pageContext.request.contextPath}/noti/'+$("#userId").val()+pg);
	    }
	...
	<div class="inner-head overlap">
		...
		<div class="container">
			<div class="inner-content">
				...
				<h2>알림내역</h2>
				<ul>
					<li><a href="${pageContext.request.contextPath}/noti/${sb:getIdStr(sbAgentDo.userId)}/${sb:getIdStr(1)}" title="">NOTIFICATION</a></li>
